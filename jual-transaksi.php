...
<div class="container mt-4">
    <div class="card">  
        <div class="card-body">
            <h5 class="card-title">Keranjang Penjualan</h5>
            <div class="row mb-3">
                <div class="col-md-4">
...
<script>
    ...
    function cariBarang(keyword) {
        fetch(`search_barang.php?keyword=${encodeURIComponent(keyword)}`)
    ...
    function editJumlah(id) {
        ...
        if (barangIndex !== -1) {
            ...
            // Ganti tampilan jumlah dengan input field dan tombol simpan
